...
import { LiaAwardSolid, LiaTrophySolid } from "react-icons/lia";
  ...
  return (
    <Card className="md:col-span-7">
      ...
      <CardContent className="flex flex-col items-center justify-center h-3/5">
        {accuracy > 75 ? (
          <>
            <LiaTrophySolid className="mr-4" stroke="gold" size={50} />
          ...
          <>
            <LiaTrophySolid className="mr-4" stroke="silver" size={50} />
          ...
          <>
            <LiaTrophySolid className="mr-4" stroke="brown" size={50} />

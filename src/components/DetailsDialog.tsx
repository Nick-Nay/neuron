...
import {LuGithub, LuHelpCircle, LuYoutube} from "react-icons/lu";
    ...
    <Dialog>
      <DialogTrigger>
        <span className="flex items-center px-2 py-1 text-white rounded-md bg-slate-800">
          What is this
          <LuHelpCircle className="w-5 h-5 ml-1" />
        </span>
      </DialogTrigger>
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Neuron!</DialogTitle>
          <DialogDescription>
            <div className="flex items-center gap-3 my-2">
              <p className="flex items-center">
                ...
                <Link
                  ...
                  href="https://github.com/Nick-Nay"
                >
                  GitHub
                </Link>
              </p>
              <p className="flex items-center">
                ...
                <Link
                  className="ml-1 underline"
                  href="https://youtube.com/@nayneuron"
                >
                  YouTube
                </Link>
              </p>
            ...
            <p className="my-2 mt-4 ">
              ...
              the ordinary and embrace the extraordinary with Neuron! Our

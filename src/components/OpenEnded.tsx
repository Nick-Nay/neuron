...
import { LuBarChart, LuChevronRightSquare, LuLoader, LuTimer } from "react-icons/lu";
  ...
  return (
    <div className="absolute -translate-x-1/2 -translate-y-1/2 md:w-[80vw] max-w-4xl w-[90vw] top-1/2 left-1/2">
      ...
      <div className="flex flex-col items-center justify-center w-full mt-4">
        ...
        >
          {isChecking && <LuLoader className="w-4 h-4 mr-2 animate-spin" />}
          Next <LuChevronRightSquare className="w-4 h-4 ml-2" />
        </Button>
      </div>
    </div>
  );
